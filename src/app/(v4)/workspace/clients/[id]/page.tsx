// ============================================================
// /workspace/clients/[id] — 客戶詳情(streaming)
// ============================================================
// 設計:
    ...
    return (
      <div className="grid place-items-center px-8 py-20">
        <div className="grid gap-3 text-center">
          ...
          <Link href="/workspace/clients" className="inline-flex items-center gap-1.5 font-v4-mono text-xs font-semibold text-ink/55 hover:text-ink">
